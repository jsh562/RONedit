...
use ron_core::{format, parse, BlankLinePolicy, FormatConfig, FormatResult, SyntaxKind};
...
fn collect_keys(node: &ron_core::SyntaxNode, out: &mut Vec<String>) {
    use ron_core::SyntaxElement;
